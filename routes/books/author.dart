...
Future<Response> onRequest(
  ...
  switch (context.request.method) {
    case HttpMethod.get:
      return MongoClient.startConnection(context, _getBookByAuthor(context));
...
Future<Response> _getBookByAuthor(RequestContext context) async {
  try {
    ...
    final categoryResponse = await bookServiceImpl
        .searchByAuthor(requestJson['name'].toString());
