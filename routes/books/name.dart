...
Future<Response> onRequest(
  ...
  switch (context.request.method) {
    case HttpMethod.get:
      return MongoClient.startConnection(context, _getBookByName(context));
...
Future<Response> _getBookByName(RequestContext context) async {
  try {
    ...
    final categoryResponse = await bookServiceImpl
        .searchByName(requestJson['name'].toString());
